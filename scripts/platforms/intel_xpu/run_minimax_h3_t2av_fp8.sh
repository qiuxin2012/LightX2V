...
config_json=${CONFIG_JSON:-${lightx2v_path}/configs/platforms/intel_xpu/minimax_h3_t2av_fp8.json}
output_path=${OUTPUT_PATH:-${lightx2v_path}/save_results/output_lightx2v_minimax_h3_t2av_fp8.mp4}
