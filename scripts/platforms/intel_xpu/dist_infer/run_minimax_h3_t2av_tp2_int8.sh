...
config_json=${CONFIG_JSON:-${lightx2v_path}/configs/platforms/intel_xpu/dist_infer/minimax_h3_t2av_tp2_int8.json}
output_path=${OUTPUT_PATH:-${lightx2v_path}/save_results/output_lightx2v_minimax_h3_t2av_tp2_int8.mp4}
...
# Keep TP reductions on oneCCL's simple path. The large all-reduce path can
# fail while opening Level Zero IPC handles on some driver/oneCCL combinations.
