...
output_path=${OUTPUT_PATH:-${lightx2v_path}/save_results/output_lightx2v_minimax_h3_t2av_int8_sp2_tp2_vtune.mp4}
...
export VTUNE_OUTPUT_DIR=${VTUNE_OUTPUT_DIR:-${lightx2v_path}/logs/vtune-int8}
